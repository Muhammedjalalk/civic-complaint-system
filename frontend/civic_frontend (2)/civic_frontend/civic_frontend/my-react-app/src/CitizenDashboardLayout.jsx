...
//   useEffect(() => {
//     // Fetch stored login name  
//     const storedName = localStorage.getItem("full_name"); // citizen name
//     if (storedName) {
//       setCitizenName(storedName);
//     }
//   }, []);

//   const photo = "https://cdn-icons-png.flaticon.com/512/149/149071.png";
...
//           <img src={photo} alt="Citizen" className="profile-img" />
          
//           <h3 className="profile-name">{citizenName || "Citizen"}</h3>

//           <h2 className="welcome-heading">
//             Welcome, {citizenName ? citizenName : "Citizen"} 👋
//           </h2>

//           <p className="profile-role">Registered Citizen</p>
//         </div>

//         <h2 className="logo">Citizen Panel</h2>

//         <ul className="nav-list">
//           <li><a href="/">Home</a></li>
//           <li><a href="/citizen-profile">Profile</a></li>
//           <li><a href="/citizen/complaints">Complaints</a></li>
//           <li><a href="/citizen/complaints/History">Complaint view</a></li>
//           <li><a href="/citizen_view_final/">Verified Complaint details</a></li>
//           <li><a href="/citizen/escalations">Esclated complaint Status</a></li>
//           <li><a href="/complaint_feedback/">Feedback</a></li>
...
//           <span>Welcome, {citizenName || "Citizen"}</span>
//         </header>
...
//   // Government portal background image (can be changed)
...
//     //   name: "Feedback",
//     //   icon: "💬",
//     //   path: "/complaint_feedback/"
//     // }
//   ];

//   const stats = [
//     { label: "Total Complaints", value: "24", color: "primary" },
//     { label: "Verified", value: "18", color: "success" },
//     { label: "In Progress", value: "4", color: "warning" },
//     { label: "Pending", value: "2", color: "info" }
//   ];
...
//               <button className="btn btn-outline-light btn-sm dropdown-toggle d-flex align-items-center" type="button">
//                 <img 
...
//                       {item.isActive && (
//                         <span className="badge bg-warning ms-auto">Active</span>
//                       )}
//                     </div>
//                   </button>
//                 ))}
...
//                       Track your verified complaints and stay updated on government actions.
//                     </p>
//                   </div>
...
//                       <h2 className={`text-${stat.color} fw-bold mb-2`}>{stat.value}</h2>
...
//                     </h5>
//                     <small className="text-muted">Government Verified & Action Taken Reports</small>
//                   </div>
...
//                     GOVERNMENT VERIFIED COMPLAINTS
//                   </h6>
//                   <small className="text-muted">
//                     These complaints have been officially verified by concerned government departments
//                   </small>
//                 </div>
...
//                     </div>
//                     <div>
//                       <h6 className="fw-bold mb-1">Important Government Notice</h6>
//                       <p className="mb-0 text-muted small">
//                         All verified complaints are subject to government audit and periodic review. 
//                         For any discrepancies, contact the Grievance Redressal Officer at your district office.
//                       </p>
//                     </div>
//                   </div>
//                 </div>
...
//                     <h6 className="fw-bold mb-3">Complaint Status Legend</h6>
//                     <div className="row">
//                       {[
//                         { color: 'success', text: 'Resolved', desc: 'Complaint fully addressed' },
//                         { color: 'primary', text: 'In Progress', desc: 'Under government review' },
//                         { color: 'warning', text: 'Pending', desc: 'Awaiting department action' },
//                         { color: 'info', text: 'Escalated', desc: 'Referred to higher authority' }
//                       ].map((item, index) => (
//                         <div className="col-md-3 mb-2" key={index}>
//                           <div className="d-flex align-items-center">
//                             <div className={`bg-${item.color} rounded-circle me-2`} style={{ width: '12px', height: '12px' }}></div>
//                             <div>
//                               <strong>{item.text}</strong>
//                               <small className="d-block text-muted">{item.desc}</small>
//                             </div>
//                           </div>
//                         </div>
//                       ))}
