...
//   // FIXED: Map backend full_name to name for frontend compatibility
//   const fetchProfile = async () => {
//     try {
//       const response = await privateAPI.get("/accounts/citizen/profile/");
//       const data = response.data;
      
//       // Map backend full_name field to name for frontend use
//       // Also handle other potential naming variations
//       const mappedProfile = {
//         ...data,
...
//                 </div>
//                 <h4 className="text-primary mb-2">Loading Profile</h4>
...
//         <div className="row justify-content-center">
//           <div className="col-md-6 col-lg-5">
//             <div className="card shadow-sm border-danger animate__animated animate__shakeX">
//               <div className="card-header bg-danger text-white">
//                 <h4 className="mb-0">⚠️ Access Error</h4>
//               </div>
//               <div className="card-body text-center py-4">
//                 <div className="display-1 text-danger mb-3">!</div>
//                 <h4 className="text-danger mb-3">Failed to Load Profile</h4>
//                 <p className="text-muted mb-4">You don't have permission to access this profile (403 Forbidden)</p>
//                 <button 
...
//   // Debug: Log profile data to see what's being received
...
//             <div className="card-header bg-primary-gradient text-white py-4 position-relative">
//               <div className="position-absolute top-0 end-0 p-3">
//                 <span className="badge bg-success rounded-pill">Active Citizen</span>
//               </div>
//               <div className="text-center">
//                 <div className="profile-avatar mx-auto mb-3 bg-white text-primary rounded-circle d-flex align-items-center justify-content-center"
//                      style={{ width: '80px', height: '80px', fontSize: '2.5rem', boxShadow: '0 4px 15px rgba(0,0,0,0.2)' }}>
//                   {profile.name ? profile.name.charAt(0).toUpperCase() : '👤'}
//                 </div>
//                 <h2 className="h3 mb-1">{profile.name || "Citizen User"}</h2>
//                 <p className="mb-0 opacity-75">Welcome to your profile dashboard</p>
//               </div>
//             </div>
...
//                       <div className="me-3" style={{ width: '40px', textAlign: 'center' }}>
...
//                         {/* Show original backend field names for debugging */}
//                         <small className="text-info">
//                           {profile.full_name && profile.full_name !== profile.name ? 
//                             `(Backend: ${profile.full_name})` : ''}
//                         </small>
//                       </div>
//                     </div>
//                   </div>
...
//                         <h6 className="fw-bold mb-0">{profile.email || "Not provided"}</h6>
//                       </div>
//                     </div>
//                   </div>
...
//                          onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#f8f9fa'}>
//                       <div className="me-3" style={{ width: '40px', textAlign: 'center' }}>
//                         <span className="text-purple fs-5">📱</span>
//                       </div>
//                       <div className="flex-grow-1">
...
//                   {/* Show all available profile fields for debugging */}
//                   {process.env.NODE_ENV === 'development' && (
//                     <div className="col-12 mt-4">
//                       <details>
//                         <summary className="text-muted small">Debug: All Profile Fields</summary>
//                         <pre className="bg-dark text-white p-3 rounded mt-2 small">
...
//                   <div className="col-6">
//                     <div className="text-center p-3 rounded-3 bg-light border"
//                          style={{ 
//                            transition: 'all 0.3s ease',
//                            cursor: 'pointer'
//                          }}
...
//                       </div>
//                       <small className="text-muted">Issues Resolved</small>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                   <small className="text-muted">Your profile is verified and active</small>
//                 </li>
//                 <li className="mb-2 d-flex align-items-start">
//                   <span className="me-2 text-success">✓</span>
//                   <small className="text-muted">All information is kept secure and private</small>
//                 </li>
//                 <li className="d-flex align-items-start">
//                   <span className="me-2 text-success">✓</span>
//                   <small className="text-muted">You can update your information anytime</small>
//                 </li>
//               </ul>
//             </div>
//           </div>
