...
//     try {
//       await API.post("/citizen/register/", formData); // API endpoint
...
//     try {
//       await API.post("/citizen/register/", formData);

//       // IMPORTANT: Do not navigate to login — ask user to verify email
//       setSuccess("✅ Registration successful! Please check your email to activate your account.");
      
//     } catch (err) {
//       if (err.response && err.response.data) {
//         // Display backend error (ex: email already exists)
