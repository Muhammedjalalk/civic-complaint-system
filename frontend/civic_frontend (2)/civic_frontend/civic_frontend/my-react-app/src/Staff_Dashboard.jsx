...
//             <div className="card shadow animate__animated animate__fadeInUp animate__delay-1s">
...
//           {/* Card 2 */}
//           <div className="col-md-4">
//             <div className="card shadow animate__animated animate__fadeInUp animate__delay-2s">
//               <div className="card-body text-center">
//                 <div className="display-4 mb-3">⏱️</div>
//                 <h5 className="card-title">Work Status</h5>
//                 <p className="text-muted">
...
//           {/* Card 3 */}
//           <div className="col-md-4">
//             <div className="card shadow animate__animated animate__fadeInUp animate__delay-3s">
//               <div className="card-body text-center">
//                 <div className="display-4 mb-3">👤</div>
...
//         {/* Info Section */}
//         <div className="mt-5 p-4 bg-white shadow rounded animate__animated animate__fadeIn">
//           <h5 className="mb-2">📢 Notice</h5>
//           <p className="text-muted mb-0">
//             Please ensure all assigned work is completed within the given time.
//             Contact the officer if you face any issues.
//           </p>
//         </div>
//       </div>
//     </div>
