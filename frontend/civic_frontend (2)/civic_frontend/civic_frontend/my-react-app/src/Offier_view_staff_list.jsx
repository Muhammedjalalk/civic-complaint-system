...
//     try {
//       const response = await axios.get("http://127.0.0.1:8000/api/officer/pending/", {
...
//       );
//       // Update staffList locally after successful update
...
//       );
//     } catch (err) {
//       setError(err.response?.data?.error || `Failed to ${status} staff.`);
//     }
//   };
...
//         "http://127.0.0.1:8000/api/officer/pending/",
//         { withCredentials: true }
//       );
//       setStaffList(response.data.pending_staff);
//     } catch (err) {
