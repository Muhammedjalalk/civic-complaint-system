              ...
              <div className="card-body p-4 p-md-5">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="text-center pt-3 border-top">
                    <div className="row">
                      <div className="col-4">
                        <Link to="/citizen-register" className="text-decoration-none">
                          <small className="text-success fw-semibold">Citizen Sign Up</small>
                        </Link>
                      </div>
                      <div className="col-4">
                        <Link to="/officer-register" className="text-decoration-none">
                          <small className="text-primary fw-semibold">Officer Sign Up</small>
                        </Link>
                      </div>
                      <div className="col-4">
                        <Link to="/staff-register" className="text-decoration-none">
